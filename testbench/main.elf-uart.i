...
{
    while((((*(volatile uint32_t *)(0x31000000 | 0x08))>>3) & 1));
    (*(volatile uint32_t *)(0x31000000 | 0x04)) = n;
}
...
void __attribute__ ( ( section ( ".mprj" ) ) ) uart_write_char(char c)
{
 if (c == '\n')
  uart_write_char('\r');
    ...
    while((((*(volatile uint32_t *)(0x31000000 | 0x08))>>3) & 1));
    (*(volatile uint32_t *)(0x31000000 | 0x04)) = c;
}
...
{
 char num;
    if(((((*(volatile uint32_t *)(0x31000000 | 0x08))>>5) | 0) == 0) && ((((*(volatile uint32_t *)(0x31000000 | 0x08))>>4) | 0) == 0)){
        for(int i = 0; i < 1; i++)
            asm volatile ("nop");

        num = (*(volatile uint32_t *)(0x31000000 | 0x00));
    }
