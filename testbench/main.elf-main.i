...
void __attribute__ ( ( section ( ".mprjram" ) ) ) Hardware_test(){
 ...
 (*(volatile uint32_t*)0x2600000c) = (0xAB00<<16);

 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (fir_taps_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (0 << 9) |
      (0 << 7) |
      (11<<0);

 while(!((*(volatile uint32_t *)(0x30008000 | 0x00)) & (1<<11))) ;

 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (fir_input_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (0 << 9) |
      (0 << 7) |
      (64<<0);
 ...
 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (fir_output_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (1 << 9) |
      (0 << 7) |
      (64<<0);
 ...
 (*(volatile uint32_t*)0x2600000c) = (0xAB01<<16);


 (*(volatile uint32_t*)0x2600000c) = (0xAB10<<16);

 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (mat_A_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (0 << 9) |
      (1 << 7) |
      ((4*4)<<0);
 ...
 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (mat_B_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (0 << 9) |
      (1 << 7) |
      ((4*4)<<0);
 ...
 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (mat_output_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (1 << 9) |
      (1 << 7) |
      ((4*4)<<0);
 ...
 (*(volatile uint32_t*)0x2600000c) = (0xAB11<<16);


 (*(volatile uint32_t*)0x2600000c) = (0xAB20<<16);

 (*(volatile uint32_t *)(0x30008000 | 0x04)) = (qsort_input_base<<0);
 (*(volatile uint32_t *)(0x30008000 | 0x00)) = (1 << 10) |
      (0 << 9) |
      (2 << 7) |
      (10<<0);
 ...
 (*(volatile uint32_t*)0x2600000c) = (0xAB21<<16);
