...
set files [list \
  ...
  [file normalize "${origin_dir}/vvd_srcs/caravel_soc/rtl/header/user_defines.v"] \
  [file normalize "${origin_dir}/vvd_srcs/caravel_soc/rtl/header/defines.v"] \
  [file normalize "${origin_dir}/../rtl/user/user_project_wrapper.v"] \
  [file normalize "${origin_dir}/../rtl/user/DMA/DMA_Controller.v"] \
  [file normalize "${origin_dir}/../rtl/user/Cache/instru_cache.v"] \
  [file normalize "${origin_dir}/../rtl/user/BRAM/bram_controller_u0.v"] \
  [file normalize "${origin_dir}/../rtl/user/BRAM/bram_controller_u1.v"] \
  [file normalize "${origin_dir}/../rtl/user/BRAM/bram.v"] \
  [file normalize "${origin_dir}/../rtl/user/Arbiter/Arbiter_new.v"] \
  [file normalize "${origin_dir}/../rtl/user/ASIC/accelerator.v"] \
  [file normalize "${origin_dir}/../rtl/user/ASIC/firmat.v"] \
  [file normalize "${origin_dir}/../rtl/user/ASIC/sorting.v"] \
  [file normalize "${origin_dir}/../rtl/user/FIFO/data_FIFO.v"] \
  [file normalize "${origin_dir}/../rtl/user/FIFO/synchronous_fifo.v"] \
  [file normalize "${origin_dir}/../rtl/user/FIFO/synchronous_fifo.v"] \
  [file normalize "${origin_dir}/../rtl/user/user_project_wrapper.v"] \
  [file normalize "${origin_dir}/../rtl/user/uart/uart_ctrl.v"] \
  [file normalize "${origin_dir}/../rtl/user/uart/uart_rx.v"] \
  [file normalize "${origin_dir}/../rtl/user/uart/uart_tx.v"] \
  [file normalize "${origin_dir}/../rtl/user/uart/uart.v"] \
  [file normalize "${origin_dir}/../rtl/user/defines.v"] \
]
